...
public class Detector {
    ...
    // Webcam constants:
    private static final String WEBCAM_CONFIG_NAME = "Frontcam";
    ...
    private static final int THRESHOLD = 20; // Any amount of red/blue pixels greater than THRESHOLD is considered as a (visible) marker.
